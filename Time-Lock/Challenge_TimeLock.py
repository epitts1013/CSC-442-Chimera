...
print(hashedTime.hexdigest(), " This is a hashTime")
...
# get middle character for the end of the code
# hashy = hashedTime.hexdigest()
# for char in hashedTime.hexdigest():
#     if (charPattern.match(char) or numPattern.match(char)):
#         hashy += char
# print(hashy)
code += hashedTime.hexdigest()[int(len(hashedTime.hexdigest())/2)]
